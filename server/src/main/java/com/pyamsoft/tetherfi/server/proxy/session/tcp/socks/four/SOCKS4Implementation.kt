...
internal class SOCKS4Implementation @Inject internal constructor(
    ...
    override suspend fun udpAssociate(
        ...
        usingResponder(proxyOutput) { sendRefusal(addressType) }
    }
    ...
    override suspend fun handleSocksCommand(
        ...
        val addressType = SOCKS4AddressType
    ...
    internal value class Responder internal constructor(
        ...
        override suspend fun sendRefusal(addressType: SOCKS4AddressType) {
            return sendPacket(
        ...
        override suspend fun sendError(addressType: SOCKS4AddressType) {
            // SOCKS4 does not differentiate between "something went wrong" and "no"
            return sendRefusal(addressType)
        }
