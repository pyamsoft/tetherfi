...
@Suppress("unused")
val Icons.Filled.PortableWifiOff: ImageVector
  get() {
    if (_portableWifiOff != null) {
      return _portableWifiOff!!
    }
    _portableWifiOff =
        materialIcon(name = "Filled.PortableWifiOff") {
          materialPath {
...
@Suppress("ObjectPropertyName") private var _portableWifiOff: ImageVector? = null
